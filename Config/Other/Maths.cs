...
namespace Training
{
    public class ManageNumber
    {
        ...
        public static string convert(float chiffre, LANGUE l)
        {
            switch (l)
            {
                case LANGUE.FR: return convertFr(chiffre);
                default : return string.Empty;
            }
        }
        public static string convertFr(float chiffre)
        {
            ...
            lettre = lettre.Replace("un mille", "mille");
            return lettre.Trim();
        }
